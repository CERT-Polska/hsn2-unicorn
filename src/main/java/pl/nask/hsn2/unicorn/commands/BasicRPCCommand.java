...
public abstract class BasicRPCCommand extends RPCCommand {

	public BasicRPCCommand(String requestType, String queueName) throws ConnectionException {
		super(requestType, queueName);
	}
	...
	protected void displayResults(String responseMessage) {
